<?php
    ...
    //Params
    $queryRoute = "SELECT DISTINCT r.R_name, b.B_model, r.R_id, b.B_id, b.B_reg_no, r.R_start, r.R_end, l.L_id, l.L_longitude, l.L_latitude
                   FROM route AS r
                   LEFT JOIN driver AS d ON r.R_id = d.R_id 
                   LEFT JOIN bus AS b ON d.B_id = b.B_id
                   LEFT JOIN location AS l ON b.B_id = l.B_id
                   WHERE ? = ?";
    $typeRoute = "ii";
    $paramsRoute = [1, 1];
